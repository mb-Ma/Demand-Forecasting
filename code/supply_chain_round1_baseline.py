...
class SupplyChainRound1Baseline:
    def __init__(self):
        self.using_hist = pd.read_csv("../data/Dataset/demand_train_A.csv") # 历史需求
        self.using_future = pd.read_csv("../data/Dataset/demand_test_A.csv") # 未来信息
        self.inventory = pd.read_csv("../data/Dataset/inventory_info_A.csv")
